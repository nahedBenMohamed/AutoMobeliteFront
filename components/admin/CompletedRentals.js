...
function CompletedRental() {
    ...
    useEffect(() => {
        setIsLoading(true);
        axios.get('/api/admin/manage-reservation/completed')
            .then(response => {
                ...
                rental.length === 0 ? (
                    <div className="flex justify-center items-center h-full w-full ">
                        ...
                        <div className="flex flex-col justify-center items-center">
                            <div className="uppercase text-2xl font-bold">you do not have a completed reservation</div>
                        </div>
                    </div>
                                                                ...
                                                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                                    ...
                                                                    <div className="mt-2">
                                                                        <p className="text-sm text-justify text-gray-500">
                                                                            Are you sure you want to delete the rental for the car <span className="text-blue-500 uppercase">{rentalDelete.car.brand} {rentalDelete.car.model}</span> ? All of your data in this rental will be removed. This action cannot be undone.
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
...
export default CompletedRental;
