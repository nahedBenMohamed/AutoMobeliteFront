...
function FinanceDoughnutChart({ data }) {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <div ref={centerEl}>{data.net} DT</div>
    </div>
  );
}
...
function RevenusDepenses() {
  ...
  useEffect(() => {
    const url = selectedCarId
      ? `/api/admin/rapport/rapport?carId=${selectedCarId}`
      : "/api/admin/rapport/rapport";
                  ...
                  <tr key={car.id}>
                    ...
                    <td className="px-6 py-4 flex justify-center">
                      <a
                        ...
                        className="text-blue-500 hover:text-blue-700 mx-1 flex items-center cursor-pointer"
                      >
