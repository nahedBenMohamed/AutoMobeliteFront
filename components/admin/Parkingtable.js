        ...
        <div className='mt-16'>
            ...
            <div className="mb-4 flex justify-between">
                <button onClick={goToParking} className=" uppercase bg-blue-500 text-white p-2 rounded mx-1">
                    {isLoadingNew ? "Add Park" : "Add Park"}
                ...
                parkings.length === 0 ? (
                    <div className="flex justify-center items-center h-full w-full ">
                        <div className="mt-8 flex items-center justify-center transform -rotate-12 w-32 h-32 overflow-hidden rounded shadow-lg mr-5">
                            <img className="h-full w-full object-cover" src="/no-parking.png" alt="No reservations" />
                        </div>
                                ...
                                {currentParkings
                                    ...
                                    .map((parking) => (
                                        <tr key={parking.id}>
                                            ...
                                            <td className="text-center">{parking.address}</td>
                                            <td className="text-center">{parking.city}</td>
                                            <td className="justify-center items-center ">
                                                <button onClick={() => goEditParking(parking.id)} className="bg-blue-500 text-white p-2 rounded mx-1">
                                                    <MdEdit size={18} />
                                                </button>
                                                <button
                        ...
                        <div className="flex justify-center mt-4">
                            {parkings.length > parkingsPerPage && (
                                <ul className="flex items-center">
                                    ...
                                    {currentPage !== Math.ceil(parkings.length / parkingsPerPage) &&
                                        <>
                                            <li>
                                                <button
                                            ...
                                            <li>
                                                <button
                                                    onClick={() => setCurrentPage(Math.ceil(parkings.length / parkingsPerPage))}
                                                    className="bg-gray-200 hover:bg-gray-300 text-gray-600 font-bold py-2 px-4 mx-1 rounded"
                                                >
                                                    Last
                                                </button>
