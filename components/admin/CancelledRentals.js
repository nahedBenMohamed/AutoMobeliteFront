...
function CancelledRental() {
  ...
  useEffect(() => {
    setIsLoading(true);
    axios
      .get("/api/admin/manage-reservation/cancelled")
      .then((response) => {
  ...
  const deleteRental = async (rentalId) => {
    try {
      await axios.delete(
        `/api/admin/manage-reservation/cancelled?id=${rentalId}`,
  ...
  const deleteAll = async () => {
    try {
      await axios.delete(`/api/admin/manage-reservation/delete-all-cancelled`, {
        withCredentials: true,
      });
        ...
        <div className="flex justify-center items-center h-full w-full ">
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="uppercase text-2xl font-bold">
              you do not have a canceled reservation
            </div>
          </div>
        </div>
      ) : (
