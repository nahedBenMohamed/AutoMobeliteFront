...
export default function Carform({ id }) {
  ...
  async function saveCar(ev) {
    ...
    try {
      if (id) {
        await axios.put(
          `/api/admin/manage-cars/cars?id=${id}`,
          { ...data, id },
          { withCredentials: true },
        );
      } else {
        await axios.post("/api/admin/manage-cars/cars/", data, {
          withCredentials: true,
        });
      }
  ...
  async function uploadImage(ev) {
    ...
    if (files?.length > 0) {
      ...
      data.append("id", id);
      try {
        const res = await axios.post("/api/admin/manage-cars/upload", data, {
          withCredentials: true,
        });
  ...
  async function deleteImage() {
    ...
    setImages([]);
    try {
      await axios.delete(`/api/admin/manage-cars/delete?id=${id}`, {
        withCredentials: true,
      });
          ...
          <div className="flex flex-row justify-center items-center mt-4 mb-4 rounded-lg">
            <form onSubmit={saveCar} className="flex-1">
              <div className="grid grid-cols-2 gap-4">
                <div className="mb-4">
                  <label htmlFor="parkingName" className="block text-xs mb-1">
                    Parking:
                  </label>
                ...
                <div className="mb-4">
                  <label htmlFor="brand" className="block text-xs mb-1">
                    Brand:
                  </label>
                  <div className="relative">
                    <input
                ...
                <div className="mb-4">
                  <label htmlFor="fuel" className="block text-xs mb-1">
                    Fuel:
                  </label>
                  <div className="relative">
                    <input
