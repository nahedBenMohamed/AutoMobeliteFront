...
const RentalTable = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    axios
      .get("/api/admin/manage-reservation/reservation")
      .then((response) => {
  ...
  const handleDeleteRental = async () => {
    try {
      await axios.delete(
        `/api/admin/manage-reservation/reservation?id=${rentalDelete.id}`
      );
                              ...
                              <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div className="mt-2">
                                  <p className="text-sm text-justify text-gray-500">
                                    Are you sure you want to delete car rental{" "}
                                    ...
                                    from customer{" "}
                                    <span className="text-blue-500 uppercase">
                                      {rentalDelete.client.name}{" "}
                                      {rentalDelete.client.firstname}
                                    </span>{" "}
