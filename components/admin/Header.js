...
function DashboardHeader() {
    ...
    useEffect(() => {
        ...
        if (token) {
            ...
            const expirationThresholdInSeconds = currentTimeInSeconds + (3 * 60); // Expiration after 3 minutes

            if (expirationTimeInSeconds < expirationThresholdInSeconds) {
                setIsModalOpen(true);
            }
        }
    }, []);
                            ...
                            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                                <div className="flex h-16 items-center justify-between">
                                    ...
                                    <ReactModal
                                        ...
                                        contentLabel="Expired Token Modal"
                                    >
                                        <h2>Expired Token</h2>
                                        <p>Your JWT token has expired. Please sign in again.</p>
