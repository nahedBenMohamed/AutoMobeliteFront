...
const SuperAdminCartable = () => {
    ...
    useEffect(() => {
        axios.get('/api/super-admin/cars').then((response) => {
    ...
    const handleDeleteCar = async () => {
        try {
            await axios.delete(`/api/super-admin/cars?id=${carToDelete.id}`, { withCredentials: true });
                                ...
                                {currentCars.map((car) => (
                                    <tr key={car.id} className="hover:bg-gray-100">
                                        ...
                                        <td className="px-6 py-4 flex justify-center">
                                            ...
                                            <Link href={`/super-admin/dashboard/cars/details/${car.id}`} className="text-gray-500 hover:text-gray-700 mx-1">
                                                <FiInfo size={18} />
                                            </Link>
                                        </td>
                                    </tr>
