...
export default function SuperAdminMaintenanceEdit({ id }) {
    ...
    useEffect(() => {
        if (id) {
            axios
                .get(`/api/super-admin/manage-maintenance/maintenance?id=${id}`, { withCredentials: true })
                .then((response) => {
    ...
    async function rental(ev) {
        ...
        try {
            if (id) {
                await axios.put(`/api/super-admin/manage-maintenance/maintenance/`, { ...data, id }, { withCredentials: true });
            }
                ...
                <div className="grid grid-cols-2 gap-8">
                    ...
                    <form onSubmit={rental} className="flex-1">
                        ...
                        <div className="mt-8 text-center">
                            <p className="text-xl font-bold">Current Total Maintenance: {price} DT</p>
                        </div>
