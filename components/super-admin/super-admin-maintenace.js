...
const SuperAdminMaintenancetable = () => {
  ...
  useEffect(() => {
    axios
      .get("/api/super-admin/manage-maintenance/maintenance", {
    ...
    <div className="mt-16">
      ...
      {isLoading ? (
        ...
        <div className="flex justify-center items-center h-full w-full">
          <div className="flex items-center justify-center transform -rotate-12 w-32 h-32 overflow-hidden rounded shadow-lg mr-5">
            <img
              ...
              src="/no-maintenance.png"
              alt="No maintenance"
            />
          </div>
          <div className="flex flex-col justify-center items-center">
            <div className="uppercase text-2xl font-bold">
              You do not have a maintenance planned
            </div>
          </div>
        </div>
      ) : (
        <>
                ...
                {currentMaintenance
                  .filter(
                    (maintenance) =>
                      ...
                      maintenance.car.registration
                        .toLowerCase()
                        .includes(search.toLowerCase()) ||
                      maintenance.car.Agency.name
                        .toLowerCase()
                        .includes(search.toLowerCase())
                  )
                  .map((maintenance) => (
          ...
          <div className="flex justify-center mt-4">{/*Pagination here*/}</div>
                    ...
                    <div className="w-full sm:w-1/2 mx-4 mt-4 sm:mt-0">
                      <div className="rounded-lg p-4 space-y-4">
                        ...
                        <p>
                          ...
                          {new Date(selectedCar.startDate).toLocaleDateString()}
                        </p>
                        <p>
                          <span className="font-bold">End Date:</span>&nbsp;
                          {new Date(selectedCar.endDate).toLocaleDateString()}
                        </p>
                        <p>
                          <span className="font-bold">Agency:</span>&nbsp;
                          {selectedCar.car.Agency.name}
                        </p>
                        <p>
