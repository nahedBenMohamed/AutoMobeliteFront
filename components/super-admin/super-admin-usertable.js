          ...
          <table className="min-w-full">
            <thead className="text-center">
              <tr>
                ...
                <th
                  scope="col"
                  className="px-6 py-3 text-xs font-medium text-center text-gray-500 uppercase tracking-wider"
                >
                  Actions
                </th>
              </tr>
              ...
              {currentUsers
                ...
                .map((user) => (
                  <tr key={user.id}>
                    ...
                    <td
                      className={`className="px-6 py-4 whitespace-nowrap" ${
                        user.emailVerified
                    ...
                    >
                      {user.status === "activate" ? "Actif" : "Disable"}
                    </td>
                    <td className="px-6 py-4 flex justify-center">
                      <Link
                        href={`/super-admin/dashboard/users/edit/${user.id}`}
                        className="text-blue-500 hover:text-blue-700 p-2 mx-1"
                      >
                        <FiEdit size={18} />
                      </Link>
                      <button
