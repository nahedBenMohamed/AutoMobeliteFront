        ...
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="w-full sm:w-1/2 mx-4 mt-4 sm:mt-0">
            <div className="rounded-lg p-4 space-y-4">
              ...
              <p>
                <span className="font-bold">Price:</span>&nbsp;{car.price} DT
              </p>
              <p>
              ...
              <p>
                ...
                {car.parking?.name ? car.parking?.name : "N/A"}
              </p>
              <p>
              ...
              <button
                ...
                className="block text-center bg-blue-600 p-2 hover:bg-green-500 font-bold text-white rounded w-full"
              >
