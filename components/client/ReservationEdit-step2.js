...
function ReservationEditStep2() {
  ...
  const isOutsideRangeEnd = (day) => {
    ...
    while (currentDate.isSameOrBefore(maxEndDate, "day")) {
      ...
      if (
        currentDay.getFullYear() === day.year() &&
      ...
      <div className="flex-grow flex flex-col space-y-5 mt-4 ml-16 mr-8">
          ...
          <div className="flex flex-row justify-center items-center mt-4 mb-4 rounded-lg">
            <DateRangePicker
              ...
              dayClassName={({ date }) => {
                ...
                const isStartDay =
                  selectedDates.startDate &&
                  date.isSame(selectedDates.startDate, "day");
                const isEndDay =
                  selectedDates.endDate &&
                  date.isSame(selectedDates.endDate, "day");
                const isInRange =
                  selectedDates.startDate &&
                  selectedDates.endDate &&
        ...
        <div className="bg-white p-5 rounded-lg shadow-lg">
          ...
          <div className=" mt-8 flex text-justify text-sm">
            <p>
              Dear user, please note that it is imperative to specify the exact
              hours for your rental. We kindly ask you to provide precise
              details of the start and end times of your rental period.
            </p>
          </div>
        </div>
        <div className="uppercase mt-4 mb-4 text-black text-xl font-extrabold">
      ...
      <div className="flex-grow-0 mr-16">
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          <div className="flex items-center mt-4">
            ...
            <p className="text-xl">
              {selectedDates.startDate
                ? moment(selectedDates.startDate).format("DD MMMM")
                : ""}
              , {selectedStartTime}
            </p>
          </div>
          <div className="flex items-center">
            ...
            <p className="text-xl">
              {selectedDates.endDate
                ? moment(selectedDates.endDate).format("DD MMMM")
                : ""}
              , {selectedReturnTime}
            </p>
          </div>
