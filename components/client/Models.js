                ...
                <div className="w-full lg:w-1/3 px-2">
                    <div className="border border-gray-200 p-4 rounded">
                        ...
                        <div className="mt-4 py-2">
                            ...
                            <div className="mt-8">
                                <div className="flex justify-between">
                                    <div>All types</div>
                                    <Checkbox
                                        checked={showAllGearBox}
                                        onChange={handleAllGearBoxChange}
                                    />
                                </div>
                                <div className="flex justify-between">
                                    <div>Manual</div>
                                    <Checkbox checked={showManual} onChange={handleManualChange} />
                                </div>
                                <div className="flex justify-between">
                                    <div>Automatic</div>
                                    <Checkbox
                        ...
                        <div className="mt-4 py-2">
                            <div className="flex justify-between">
                                <h3>Fuel</h3>
                                <small className="cursor-pointer" onClick={resetFuelFilters}>
                                    reset
                                </small>
                            </div>
                            <div className="mt-8">
                                <div className="flex justify-between">
                                    <div>Diesel</div>
                                    <Checkbox checked={showDiesel} onChange={handleDieselChange} />
                                </div>
                                <div className="flex justify-between">
                                    <div>Petrol</div>
                                    <Checkbox checked={showEssence} onChange={handleEssenceChange} />
                                </div>
                                <div className="flex justify-between">
                                    <div>Electric</div>
                                    <Checkbox checked={showElectric} onChange={handleElectricChange} />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="w-full md:w-12/12 px-4">
                    <div className="grid grid-cols-1 gap-8">
                        {filteredCars.length > 0 ? (
                            (() => {
                                let searchFilteredCars = filteredCars.filter(
                                    (car) =>
                                ...
                                if(searchFilteredCars.length > 0) {
                                    return searchFilteredCars.map((car) => {
                                        return (
                                                    ...
                                                    <div className="p-2 w-full lg:w-1/2">
                                                        <div className="flex items-center justify-between mb-8">
                                                            <div className="space-y-1">
                                                                <div>
                                                                    <h1 className="-mt-6 font-bold text-xl lg:text-xl">
                                                                        {car.brand}
                                                                    </h1>
                                                                </div>
                                                            </div>
                                    ...
                                    return <div className="text-center font-bold text-xl mt-8">
