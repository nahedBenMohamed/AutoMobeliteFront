  ...
  return (
    <header className="w-full absolute z-10">
      <nav className="max-w-[1740px] mx-auto flex justify-between items-center sm:px-16 px-6 py-4 bg-transparent">
        <Link
          href="/"
          className="text-2xl justify-center items-center automobelite-link"
        >
        ...
        {isReservationPage() && (
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <p
              style={{
                borderBottom:
                  router.pathname === "/reservations/new/step1"
                    ? "2px solid blue"
            ...
            <p
              style={{
                borderBottom:
                  router.pathname === "/reservations/new/step2"
                    ? "2px solid blue"
                    : "2px solid transparent",
                marginRight: "40px",
              }}
            ...
            <p
              style={{
                borderBottom:
                  router.pathname === "/reservations/new/step3"
                    ? "2px solid blue"
                    : "2px solid transparent",
              }}
            >
        ...
        {isEditReservationPage() && (
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <p
              style={{
                borderBottom:
                  router.pathname === "/reservations/edit/step1"
                    ? "2px solid blue"
                    : "2px solid transparent",
                marginRight: "40px",
              }}
            ...
            <p
              style={{
                borderBottom:
                  router.pathname === "/reservations/edit/step2"
                    ? "2px solid blue"
                    : "2px solid transparent",
                marginRight: "40px",
              }}
            ...
            <p
              style={{
                borderBottom:
                  router.pathname === "/reservations/edit/step3"
                    ? "2px solid blue"
                    : "2px solid transparent",
              }}
            >
        ...
        {!isReservationPage() && !isEditReservationPage() && (
          <>
            {data?.user ? (
              ...
              <>
                {/* Conditionally render both buttons on the root URL */}
                {router.pathname === "/" && (
                  <>
                ...
                {/* Conditionally render "Register" button if on login page */}
                {router.pathname === "/authentification/login" && (
                  <>
                    <div className="hidden lg:flex">
                      <Link href="/authentification/register">
                        <button className="text-white  hover:text-blue-white transition-all px-7 py-3 rounded-full bg-blue-500 duration-600 ease-linear">
                          Register
                        </button>
                      </Link>
                    </div>
                ...
                {/* Conditionally render "Register" button if on login page */}
                {router.pathname === "/authentification/register" && (
                  <>
                    <div className="hidden lg:flex">
                      <Link href="/authentification/login">
                        <button className="text-white  hover:text-blue-white transition-all px-7 py-3 rounded-full bg-blue-500 duration-600 ease-linear">
                ...
                <div className="lg:hidden">
                  ...
                  {isDropdownOpen && (
                    ...
                    >
                      <Link href="/authentification/login">
                        <p className="block px-4 py-2 hover:bg-blue-600 cursor-pointer">
                          Login
                        </p>
                      </Link>
                      <Link href="/authentification/register">
