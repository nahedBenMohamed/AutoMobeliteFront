...
const ResetPasswordPage = ({clientId}) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put('/api/auth/reset-password', { clientId, password });
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden rounded-lg shadow-lg ">
            ...
            <div className="w-full p-4 bg-white rounded-lg shadow-lg lg:max-w-xl">
                <h1 className="mt-2 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Reset Password</h1>
