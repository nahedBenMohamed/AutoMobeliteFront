...
export default async (req, res) => {
  ...
  try {
        ...
        <div style="background-color: #f5f5f5; font-family: 'Arial', sans-serif; width: 100%; display: flex; justify-content: center;">
            <div style="max-width: 600px; width: 100%; margin: 0 auto;">
                <div style="background-color: #fff; padding: 40px;">
                    ...
                    <p style="margin-bottom: 20px;">Hello ${agent.name.toUpperCase()},</p>
                    ...
                    <div style="text-align: center; margin-top: 30px;">
                        ...
                        }/admin/reset-password?token=${resetToken}" style="background-color: #4a90e2; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block;">Reset Password</a>
                    </div>
    ...
    `,
      ...
      return res
        .status(200)
        .json({ agentUpdate: "password changed successfully" });
    } else {
