            ...
            <div style="max-width: 600px; width: 100%; margin: 0 auto;">
                <div style="background-color: #fff; padding: 40px;">
                    ...
                    <div style="text-align: center; margin-top: 30px;">
                        <a href="${process.env.BASE_URL}/admin/reset-password?token=${resetToken}" style="background-color: #4a90e2; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block;">Reset Password</a>
                    </div>
