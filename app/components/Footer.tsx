          ...
          <div>
            <ul className="space-y-2">
              <li>
                <Link
                  href="tel:123456789"
                  className="flex items-center justify-center lg:justify-start gap-2 hover:text-custom-blue transition-all duration-300 ease-linear"
                >
                  <span>
                    <BsFillTelephoneFill />
                  </span>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="#top"
                className="hover:text-custom-blue transition-all duration-300 ease-linear"
              >
                New York
              </a>
            </li>
