        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-32 lg:items-center">
          <div className="space-y-8 lg:basis-1/2">
            ...
            <div className="flex justify-center lg:justify-start">
              <a
                href="#booking"
                className="bg-custom-blue flex items-center gap-2 justify-center p-4 shadow-orange-bottom hover:shadow-orange-bottom-hov transition-all duration-300 ease-linear rounded font-bold text-white"
              >
